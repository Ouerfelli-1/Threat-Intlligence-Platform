# Ported verbatim from AvailableServices/Flowviz/flowviz-main/src/features/flow-analysis/services/directFlowPrompts.ts

PROMPT_VERSION = "v1"

DIRECT_FLOW_PROMPT = """You are an expert in cyber threat intelligence and MITRE ATT&CK. Analyze this article and create React Flow nodes and edges directly.
  ...
  "nodes": [
    {
      ...
      "data": {
        ...
        "source_excerpt": "2-3 complete sentences directly quoted from the source article",
        "confidence": "high"
      }
    }
  ],
